...
<body>
    ...
    <script>
        ...
        if (window.innerWidth <= 800) { // Este valor puede ajustarse según el tamaño que consideres móvil
            window.location.href = "index-otp-cel.php"; // Redirige a una página informando que no está disponible
        }
        ...
        document.getElementById('cancelar').addEventListener('click', () => {
            ...
            window.location.href = 'index.php'; // O redirigir a otra página
        });
    </script>
</body>
</html>
